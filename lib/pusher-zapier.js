...
function hmacWrapper( secret ) {
  this.hmac = CryptoJS.algo.HMAC.create( CryptoJS.algo.SHA256, secret );

  this.update = function( str ) {
    this.hmac.update( str );
    return this;
  };
  ...
  this.digest = function( type ) {
    ...
    return this.hmac.toString( CryptoJS.enc.Hex );
  };
}
...
var Zap = {
    ...
    */
    ...
    var signature = pusher.createSignature( bundle.request.method, eventData, '/events' );
